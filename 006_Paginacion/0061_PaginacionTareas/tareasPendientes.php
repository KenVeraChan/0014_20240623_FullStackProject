<?php
        ...
        $rutaPaginaTareasPend="location:../../005_Login/";   //Se pone la ruta desde la página tareas pendientes
        cargaWebCookie($rutaPaginaTareasPend);   //Se ejecuta la función de carga página según cookie desde la página tareas pendientes    
?>
...
<body onload="cargarPagina()">
    ...
    <div class="consulta">
        ...
        <div class="tablaBBDD">
            <table id="tablaPaginacion">
                ...
                <tr class="cabecera">
                    ...
                    <td class="caja">
                        <a href="../../006_Paginacion/0062_PaginacionTareasConfirmacion/actualizarTareasPend.php?id=<?php echo($persona->ID);?>">
        ...
        <img id="imagenPortada" src="../../006_Paginacion/0061_PaginacionTareas/images/SERVIDOR.jpg" alt="Imagen servidor">
    </div>
    <div class="piePagina">
