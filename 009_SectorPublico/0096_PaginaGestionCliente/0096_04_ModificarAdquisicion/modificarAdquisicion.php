        ...
        <form action="../../../009_SectorPublico/0096_PaginaGestionCliente/consultasCliente.php" method="GET">
            <table class="seccionPrincipal">
                    ...
                    <tr class="filaVenta">
                        ...
                        <td class="celdaV"><?php echo $_SESSION["CANTIDADC"];?><br><input type="number" id="despliegue" onchange="cambiaStock(<?php echo $_SESSION['ALMACENSTOCK'];?>)" min="0" max="<?php echo $_SESSION['ALMACENSTOCK'];?>" name="cantidad" value="<?php echo $_SESSION["CANTIDADC"];?>" title="cantidad: 0, elimina el elemento del carrito. Otra cantidad, modifica lo establecido"><div><br></div><input type="submit" name="modificar" value="" class="pulsadorActualizar" title="Al pulsar se actualizará la cantidad y el precio cargados"><input type="submit" name="volver" value="" class="pulsadorVolver" title="Volver al carrito de la Compra"></td>
