...
<head>
    ...
    <link rel="shortcut icon" href="../../../009_SectorPublico/iconoSectorCliente.ico">   <!-- ICONO DE LA PAGINA PERSONAL CLIENTE -->
                    ...
                    <table id="tabla">
                        ...
                        <tr class="cajaBotonera">
                            <td>
                                ...
                                <input type="number" min="0" max="100" class="filaNombre" value="<?php if(isset($_SESSION["numeroCompras"])){echo $_SESSION["numeroCompras"];}else{echo "";}?>" name="numCompras" disabled>
                            </td>
                        </tr>
                        <tr class="cajaBotonera">
                            <td>
