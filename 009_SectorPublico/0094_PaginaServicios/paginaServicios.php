...
include "consultasMostradorServicios.php";  //CARGA EL MOSTRADOR DE PRODUCTOS PRINCIPALMENTE
    ...
    $rutaPaginaServicios="location:../../005_Login/";   //Se pone la ruta desde la página Servicios
    cargaWebCookie($rutaPaginaServicios);   //Se ejecuta la función de carga página según cookie desde la página Servicios
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="shortcut icon" href="../../009_SectorPublico/iconoSectorPublico.ico">   <!-- ICONO DE LA PAGINA SERVICIOS -->
