...
function cargarPagina()
{
    ...
    for(let i=0;i<elemento1.length;i++)
    {
        ...
        elemento1[i].style.background= "rgba(18, 0, 0, 0.89)";
    ...
    for(let i=0;i<elemento5.length;i++)
        {
            elemento5[i].addEventListener('mouseenter',function(){
                ...
                elemento5[i].style.color="rgb(139,13,13)";          
                    })
...
function letreroConfirmado(tipoLetrero)
{
    ...
    if(tipoLetrero>0 && tipoLetrero<3)
    {
        ...
        clienteNombre.addEventListener("mouseenter",function(){
                clienteLogin.style.color="rgb(219,30,9)";
                clienteNombre.style.color="rgb(219,30,9)";
        });
