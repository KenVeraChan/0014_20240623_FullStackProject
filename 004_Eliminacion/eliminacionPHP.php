<?php
        ...
        $rutaPaginaEliminaCandidato="location:../005_Login/";   //Se pone la ruta desde la página eliminar candidato
        cargaWebCookie($rutaPaginaEliminaCandidato);   //Se ejecuta la función de carga página según cookie desde la página eliminar candidato    
?>
