<?php
        ...
        $rutaPaginaBusquedaInfo="location:../../005_Login/";   //Se pone la ruta desde la página búsqueda candidato extracción información
        cargaWebCookie($rutaPaginaBusquedaInfo);   //Se ejecuta la función de carga página según cookie desde la página búsqueda candidato extracción información
?>
...
<body onload="cargarPagina()">
    <header id="cabeceraPrincipal">
        <div id="iconoAdorno"><img src="../../001_Busqueda/0011_BusquedaTABLAFIND/images/Sfer4D-IconoEmpresa.jpg" id="iconoEmpresa"></div>
    <div id="areaSesion">
        ...
        <table id="tabla">
            ...
            <tr class="cajaBotonera">    
                ...
                <td class="LlenobotonesPrincipal">
                    <button class="bloque_opciones" style="color:rgba(230, 230, 11, 0.719)" onclick="location.href='../../000_ConsultaContactos/ConsultaContactos.php'"> MENU Y BBDD</button>
                </td>
                <td class="LlenobotonesPrincipal">
                    <button class="bloque_opciones" style="color:rgba(230, 230, 11, 0.719)" onclick="location.href='../../006_Paginacion/0061_PaginacionTareas/tareasPendientes.php'">TAREAS PENDIENTES</button>
                </td>
            </tr>
        </table>
        <div class="VaciobotonesPrincipal"></div>
    </header> 
    <div class="consulta" style="background-image: url(../../001_Busqueda/0011_BusquedaTABLAFIND/images/DIGITALIZACION.jpg); background-repeat: no-repeat; background-size:cover">
        <?php
            echo "<br>";
            echo "<div id='capsula'>";
