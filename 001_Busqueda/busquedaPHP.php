<?php
        ...
        $rutaPaginaBusquedaCandidato="location:../005_Login/";   //Se pone la ruta desde la página búsqueda candidato
        cargaWebCookie($rutaPaginaBusquedaCandidato);   //Se ejecuta la función de carga página según cookie desde la página búsqeuda candidato    
?>
