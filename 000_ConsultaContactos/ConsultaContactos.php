    ...
    <div id="areaSesion">
        ...
        <table id="tabla">
            ...
            <tr class="cajaBotonera">    
                ...
                <td class="LlenobotonesPrincipal">
                    <button class="bloque_opciones" style="color: orangered" onclick="muestraTabla()">VER BBDD COMPLETA</button>
                </td>
                <td class="LlenobotonesPrincipal">
                    <button class="bloque_opciones" style="color: orangered" onclick="location.href='../000_ConsultaContactos/ConsultaContactos.php'"> VOLVER</button>
                </td>
            </tr>
        </table>
        <div class="VaciobotonesPrincipal"></div>
