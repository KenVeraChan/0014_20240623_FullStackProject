<?php
        ...
        $rutaPaginaModificaCandidato="location:../005_Login/";   //Se pone la ruta desde la página modificar candidato
        cargaWebCookie($rutaPaginaModificaCandidato);   //Se ejecuta la función de carga página según cookie desde la página modificar candidato
?>
...
<body onload="cargarPagina()">
    <header id="cabeceraPrincipal">
        <div id="iconoAdorno"><img src="../003_Actualizacion/images/Sfer4D-IconoEmpresa.jpg" id="iconoEmpresa"></div>
    <div id="areaSesion">
